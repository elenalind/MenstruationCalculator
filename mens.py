...
parser.add_argument("list", help="Type in your previous mens days separated by coma e.g. \
                                  6.12.2018,2.1.2019,27.1.2019,23.2.2019,20.3.2019,17.4.2019,\
                                  11.5.2019,5.6.2019,3.7.2019,30.7.2019",
                    type=str)
...
for item, next_item in zip(argssplit, argssplit[1:]):
    cyclelength = ((datetime.strptime(next_item, '%d.%m.%Y')) -
                   (datetime.strptime(item, '%d.%m.%Y'))).days
...
# Throw Warning if more than 30 days between mens days.
# The user can doublecheck the input.
